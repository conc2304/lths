...
const BodyTextToolbar = (props: BodyTextComponentProps) => {
  const {
    __ui_id__: id,
    default_data: { title, card_background_color, text_color, text_size, linked_text },
  } = props;
    ...
    <BasicContainer id={id}>
      <Stack spacing={2}>
        ...
        <Box>
          ...
          <ColorPicker value={text_color} onChange={(text_color) => updateComponentProp('text_color', text_color)} />
        </Box>
