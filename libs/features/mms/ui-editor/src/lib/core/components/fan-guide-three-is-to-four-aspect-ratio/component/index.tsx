        ...
        borderRadius: "10px",
          ...
          >
            ...
            <Stack direction="column" alignItems="center" spacing={2.5} >
              <Typography
                sx={{ 
                  fontSize: 16, display: 'inline-block', paddingBottom: 1,
                  borderBottom: '4px solid #BA9765', letterSpacing: '0.12em',
                  }}
              >
                FAN GUIDE
              </Typography>
              <Stack direction="column" alignItems="center" spacing={1.5} >
                <Typography
                  sx={{ fontSize: 28, fontWeight: 600, 
                    wordWrap: 'break-word', textAlign: "center", lineHeight: 1.2,
                  }}
                >
                  {title}
                </Typography>
                <Typography sx={{ fontSize: 16, wordWrap: 'break-word', textAlign: "center"  }}>
                  {description}
                </Typography>
              </Stack>
            </Stack>
