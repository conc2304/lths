...
describe("HeroPromotion: CardTextOverlayAndButton Toolbar", () => {
  ...
  test("should render CardTextOverlayAndButton toolbar component", () => {
    // Arrange
    const labelBeforeSelect = screen.queryByLabelText("Card Text Overlay And Button Toolbar");
    // Assert
    ...
    // Assert
    const labelAfterSelect = screen.getByLabelText("Card Text Overlay And Button Toolbar");
    expect(labelAfterSelect).toBeInTheDocument();

  });

    test("should render CardTextOverlayAndButton toolbar with text props", () => {
        expect(screen.queryByLabelText("Card Text Overlay And Button Toolbar")).toBeNull();
        act(() => {
        fireEvent.click(container.querySelector('button.add-component-button'));
        });
    ...
    test("should render CardTextOverlayAndButton toolbar with section labels", () => {
      expect(screen.queryByLabelText("Card Text Overlay And Button Toolbar")).toBeNull();
      act(() => {
      fireEvent.click(container.querySelector('button.add-component-button'));
      });
    ...
    test("should render CardTextOverlayAndButton toolbar with correct Labels", () => {
        expect(screen.queryByLabelText("Card Text Overlay And Button Toolbar")).toBeNull();
        act(() => {
            fireEvent.click(container.querySelector('button.add-component-button'));
        });
    ...
    describe("Image Picker Integration", () => {
        test('renders CardTextOverlayAndButton Toolbar with SimpleImagePickers', () => {
            expect(screen.queryByLabelText("Card Text Overlay And Button Toolbar")).toBeNull();
            ...
            expect(screen.getByLabelText("Card Text Overlay And Button Toolbar")).toBeInTheDocument();
    ...
    describe("Test Page Link and Page Id", () => {
      ...
      test('renders CardTextOverlayAndButton Toolbar with Correct Action Option for type', () => {
          expect(screen.queryByLabelText("Card Text Overlay And Button Toolbar")).toBeNull();
          act(() => {
            fireEvent.click(container.querySelector('button.add-component-button'));
          });
      ...
      test('updates CardTextOverlayAndButton Toolbar when page_link changes', () => {
        expect(screen.queryByLabelText("Card Text Overlay And Button Toolbar")).toBeNull();
        act(() => {
          fireEvent.click(container.querySelector('button.add-component-button'));
        });
      ...
      test('updates CardTextOverlayAndButton Toolbar when page_id changes', () => {
        expect(screen.queryByLabelText("Card Text Overlay And Button Toolbar")).toBeNull();
        act(() => {
          fireEvent.click(container.querySelector('button.add-component-button'));
        });
