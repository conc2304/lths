...
describe("HeroPromotion: SiloTextAndButton Toolbar", () => {
  ...
  test("should render SiloTextAndButton toolbar component", () => {
    // Arrange
    const labelBeforeSelect = screen.queryByLabelText("Silo Text And Button Toolbar");
    // Assert
    ...
    // Assert
    const labelAfterSelect = screen.getByLabelText("Silo Text And Button Toolbar");
    expect(labelAfterSelect).toBeInTheDocument();

  });

  test("should render SiloTextAndButton toolbar with text props", () => {
    expect(screen.queryByLabelText("Silo Text And Button Toolbar")).toBeNull();
    act(() => {
    fireEvent.click(container.querySelector('button.add-component-button'));
    });
  ...
  test("should render SiloTextAndButton toolbar with section labels", () => {
    expect(screen.queryByLabelText("Silo Text And Button Toolbar")).toBeNull();
    act(() => {
    fireEvent.click(container.querySelector('button.add-component-button'));
    });
  ...
  test("should render SiloTextAndButton toolbar with correct Labels", () => {
    expect(screen.queryByLabelText("Silo Text And Button Toolbar")).toBeNull();
    act(() => {
        fireEvent.click(container.querySelector('button.add-component-button'));
    });
  ...
  describe("Image Picker Integration", () => {
      test('renders SiloTextAndButton Toolbar with SimpleImagePickers', () => {
          expect(screen.queryByLabelText("Silo Text And Button Toolbar")).toBeNull();
          ...
          expect(screen.getByLabelText("Silo Text And Button Toolbar")).toBeInTheDocument();
  ...
  describe("Test Page Link and Page Id", () => {
    ...
    test('renders SiloTextAndButton Toolbar with Correct Action Option for type', () => {
      expect(screen.queryByLabelText("Silo Text And Button Toolbar")).toBeNull();
      act(() => {
        fireEvent.click(container.querySelector('button.add-component-button'));
      });
    ...
    test('updates SiloTextAndButton Toolbar when page_link changes', () => {
      expect(screen.queryByLabelText("Silo Text And Button Toolbar")).toBeNull();
      act(() => {
        fireEvent.click(container.querySelector('button.add-component-button'));
      });
    ...
    test('updates SiloTextAndButton Toolbar when page_id changes', () => {
      expect(screen.queryByLabelText("Silo Text And Button Toolbar")).toBeNull();
      act(() => {
        fireEvent.click(container.querySelector('button.add-component-button'));
      });
