...
describe("QuicklinkButtonGroupComponent", () => {
  ...
  test('renders component with diffrent default data', () => {
    props.properties_data.first_button.label = `The cool label 1`
    props.properties_data.first_button.icon = `The cool icon 1`
    props.properties_data.second_button.label = `The cool label 2`
    props.properties_data.second_button.icon = `The cool icon 2`
