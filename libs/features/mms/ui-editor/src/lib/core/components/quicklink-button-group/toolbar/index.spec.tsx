...
describe("QuicklinkButtonGroup Toolbar", () => {
  ...
  test("should render QuicklinkButtonGroup toolbar with text props", () => {
    ...
    const { sub_properties_data } = component.properties_data;

    // Assert
    // test quicklink 1
    expect(container.innerHTML).toContain(sub_properties_data[0].title);
    expect(container.innerHTML).toContain(sub_properties_data[0].icon);

    // test quicklink 2
    expect(container.innerHTML).toContain(sub_properties_data[1].title);
    expect(container.innerHTML).toContain(sub_properties_data[1].icon);
  });
  ...
  test("should render QuicklinkButtonGroup toolbar with correct Labels", () => {
    ...
    expect(firstLabelInput.querySelector("textarea").value).toBe(sub_properties_data[0].title);
    ...
    expect(firstIconInput.querySelector('input').value).toBe(sub_properties_data[0].icon);
    ...
    expect(secondLabelInput.querySelector("textarea").value).toBe(sub_properties_data[1].title);
    ...
    expect(secondIconInput.querySelector('input').value).toBe(sub_properties_data[1].icon);
  });

  test("should render QuicklinkButtonGroup toolbar with correct diffrent initial Labels", () => {
    component.properties_data.sub_properties_data[0].title = "Cool title 1";
    component.properties_data.sub_properties_data[1].title = "Cool title 2";
    component.properties_data.sub_properties_data[0].icon = "Cool icon 1";
    component.properties_data.sub_properties_data[1].icon = "Cool icon 2";
  ...
  describe("Test Page Link and Page Id", () => {
    test('renders QuicklinkButtonGroup Toolbar with Correct Action Option for type', () => {
      component.properties_data.sub_properties_data[0].action.type = "webview";
      component.properties_data.sub_properties_data[1].action.type = "native";
      ...
      expect(firstLinkTextArea.value).toContain(sub_properties_data[0].action.page_link);
      ...
      expect(secondPageIDTextArea.value).toContain(sub_properties_data[1].action.page_id);
