...
const ChartTooltip2 = styled(Box)<SxProps>(({ theme }) => ({
  padding: '1.2rem',
  background: '#fff',
  ...
  return (
    <Box component={'div'} sx={{ width: '100%', marginBottom: `${theme.spacing(4)}` }}>
      <Box component={'div'} sx={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
        <Box
          component="div"
          sx={{ width: '100%', display: 'flex', justifyContent: 'space-between', flexDirection: { xs: 'column', sm: 'row' }, marginTop: `${theme.spacing(1)}` }}
        >
          <Typography variant="subtitle1" color="secondary">
            IMPRESSIONS VS CLICK-THROUGHS
          </Typography>
          <Box component={'div'} sx={{ display: 'flex', alignItems: 'center', flexDirection: { xs: 'column', sm: 'row' } }}>
