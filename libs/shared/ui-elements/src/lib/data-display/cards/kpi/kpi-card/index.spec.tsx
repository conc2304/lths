...
describe("KpiCard Component", () => {
  ...
  beforeEach(() => {
    props = {
      ...
      tooltipDesc: "Revenue generated by the business",
      tooltipActionUrl: "/revenue",
    };
  });
  ...
  describe("Up Down Icons", () => {
    test("should render KpiCard component with up arrow icon", () => {
        ...
        const upArrowIcon = screen.getByTestId("UpArrowIcon");
    ...
    test("should render KpiCard component with up add icon", () => {
        ...
        const downArrowIcon = screen.getByTestId("UpAddIcon");
    ...
    test("should render KpiCard component with down arrow icon", () => {
        ...
        const downArrowIcon = screen.getByTestId("DownArrowIcon");
    ...
    test("should render KpiCard component with down remove icon", () => {
        ...
        const downArrowIcon = screen.getByTestId("DownRemoveIcon");
