  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div style={{ paddingTop: theme.spacing(1), textAlign: 'center' }} data-testid="SparkLineContainer">
            {sparkLine}
          </div>
        </AccordionSummary>
        <AccordionDetails
        ...
        >
          ...
          <Stack spacing={0.5}>
            {rolloverData.map((trendProp) => (
              <Stack key={trendProp.duration} direction="row" justifyContent="space-between">
