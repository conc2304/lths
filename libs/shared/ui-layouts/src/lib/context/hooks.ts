...
import { setPageTitle, setBreadcrumbs, setDrawerSelectedItem, setDrawerVisibility } from './actions';
...
export const useLayoutActions = () => {
  ...
  return {
    setDrawerVisibility: useMemo(() => setDrawerVisibility(dispatch), [dispatch]),
