...
import { Avatar, Box, Button, CardActions, CardContent, Divider, Grid, TextField, Typography } from '@mui/material';
...
export const UserForm = (props: Props) => {
  ...
  const {
    ...
    onSubmit: (values, { setSubmitting }) => {
      handleUpdateUser(values).finally(() => {
        setSubmitting(false);
      });
    },
  });
  ...
  const handleUpdateUser = async (values: Partial<User>) => {
    ...
    const formattedValues: typeof values = {
      ...cleanedValues,
