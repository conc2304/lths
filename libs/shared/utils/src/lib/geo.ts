...
type RegexByCountry = { [key: string]: string };

export const getCountryData = ({ code, country }: { code?: string; country?: string }): CountryType | undefined => {
  return Countries.find((c) => {
    return c.code === code || c.label === country;
  });
};
...
export const PostalRegexByCountryCode: RegexByCountry = {
