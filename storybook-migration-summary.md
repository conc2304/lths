...
- `npx storybook@latest automigrate --config-dir libs/shared/storybook/.storybook --renderer @storybook/react`

- `npx storybook@latest automigrate --config-dir libs/shared/ui-elements/.storybook --renderer @storybook/react`
